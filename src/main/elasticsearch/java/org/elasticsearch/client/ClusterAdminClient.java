...
public interface ClusterAdminClient extends ElasticsearchClient {
     ...
     * @param listener
     */
    void deleteNodes(DeleteNodeRequest request, ActionListener<DeleteNodeResponse> listener);
     ...
     * @param listener
     */
    void addNodes(AddNodeRequest request, ActionListener<AddNodeResponse> listener);
    
    void createTenant(CreateTenantRequest request, ActionListener<CreateTenantResponse> listener);
    void deleteTenant(DeleteTenantRequest request, ActionListener<DeleteTenantResponse> listener);
    void modifyTenant(ModifyTenantNodesRequest request, ActionListener<ModifyTenantNodesResponse> listener);
    void migrateIndexTenant(MigrateIndexTenantRequest request, ActionListener<MigrateIndexTenantResponse> listener);
