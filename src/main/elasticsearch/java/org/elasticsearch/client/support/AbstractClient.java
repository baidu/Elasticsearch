...
public abstract class AbstractClient extends AbstractComponent implements Client {
    ...
    static class ClusterAdmin implements ClusterAdminClient {
        ...
        @Override
        public void deleteNodes(final DeleteNodeRequest request, final ActionListener<DeleteNodeResponse> listener) {
            execute(DeleteNodeAction.INSTANCE, request, listener);
        }
        
        @Override
        public void addNodes(final AddNodeRequest request, final ActionListener<AddNodeResponse> listener) {
            execute(AddNodeAction.INSTANCE, request, listener);
        }
        
        @Override
        public void createTenant(final CreateTenantRequest request, final ActionListener<CreateTenantResponse> listener) {
            execute(CreateTenantAction.INSTANCE, request, listener);
        }
        
        @Override
        public void deleteTenant(final DeleteTenantRequest request, final ActionListener<DeleteTenantResponse> listener) {
            execute(DeleteTenantAction.INSTANCE, request, listener);
        }
        
        @Override
        public void modifyTenant(final ModifyTenantNodesRequest request, final ActionListener<ModifyTenantNodesResponse> listener) {
            execute(ModifyTenantNodesAction.INSTANCE, request, listener);
        }
        
        @Override
        public void migrateIndexTenant(final MigrateIndexTenantRequest request, final ActionListener<MigrateIndexTenantResponse> listener) {
            execute(MigrateIndexTenantAction.INSTANCE, request, listener);
        }
