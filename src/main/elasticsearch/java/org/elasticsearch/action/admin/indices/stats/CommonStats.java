...
import org.elasticsearch.index.shard.ReindexStats;
...
public class CommonStats implements Streamable, ToXContent {
        ...
        for (CommonStatsFlags.Flag flag : setFlags) {
            switch (flag) {
                ...
                case Recovery:
                    ...
                    break;
                case DL:
                    dlStats = indexShard.dlStats();
                    break;
                case Reindex:
                    reindexStats = indexShard.reindexStats();
                    break;
                default:
                    throw new IllegalStateException("Unknown Flag: " + flag);
            }
    ...
    @Nullable
    public DLStats getDLStats() {
        return dlStats;
    }

    @Nullable
    public ReindexStats getReindexStats() {
        return reindexStats;
    }
    ...
    public void writeTo(StreamOutput out) throws IOException {
        ...
        if (reindexStats == null) {
            out.writeBoolean(false);
        } else {
            out.writeBoolean(true);
            reindexStats.writeTo(out);
        }
    ...
    public XContentBuilder toXContent(XContentBuilder builder, Params params) throws IOException {
        ...
        if (dlStats != null) {
            dlStats.toXContent(builder, params);
        }
        if (reindexStats != null) {
            reindexStats.toXContent(builder, params);
        }
        return builder;
    }
}
