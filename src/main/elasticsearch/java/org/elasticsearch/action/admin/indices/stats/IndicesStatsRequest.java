...
public class IndicesStatsRequest extends BroadcastRequest<IndicesStatsRequest> {
    ...
    public IndicesStatsRequest dl(boolean dl) {
    ...
    public IndicesStatsRequest reindex(boolean reindex) {
        flags.set(Flag.Reindex, reindex);
        return this;
    }

    public boolean reindex() {
        return flags.isSet(Flag.Reindex);
    }
