...
import org.elasticsearch.action.admin.cluster.lease.GetOrChangePrimaryShardLeaseAction;
import org.elasticsearch.action.admin.cluster.lease.TransportGetOrChangePrimaryShardLeaseAction;
import org.elasticsearch.action.admin.cluster.node.add.AddNodeAction;
import org.elasticsearch.action.admin.cluster.node.add.TransportAddNodeAction;
import org.elasticsearch.action.admin.cluster.node.delete.DeleteNodeAction;
import org.elasticsearch.action.admin.cluster.node.delete.TransportDeleteNodeAction;
...
import org.elasticsearch.action.admin.cluster.tenant.alter.AlterTenantPropertyAction;
...
import org.elasticsearch.action.admin.cluster.tenant.show.ShowTenantsAction;
...
import org.elasticsearch.action.admin.cluster.user.drop.DropUserAction;
...
import org.elasticsearch.action.admin.cluster.user.whitelist.ResetWhitelistAction;
...
import org.elasticsearch.action.admin.indices.shard.IndexShardStatsAction;
...
public class ActionModule extends AbstractModule {
    ...
    protected void configure() {
        ...
        registerAction(GetOrChangePrimaryShardLeaseAction.INSTANCE, TransportGetOrChangePrimaryShardLeaseAction.class);
        registerAction(DeleteNodeAction.INSTANCE, TransportDeleteNodeAction.class);
        registerAction(AddNodeAction.INSTANCE, TransportAddNodeAction.class);
        registerAction(CreateTenantAction.INSTANCE, TransportCreateTenantAction.class);
        registerAction(DeleteTenantAction.INSTANCE, TransportDeleteTenantAction.class);
        registerAction(MigrateIndexTenantAction.INSTANCE, TransportMigrateIndexTenantAction.class);
        registerAction(ModifyTenantNodesAction.INSTANCE, TransportModifyTenantNodesAction.class);
        registerAction(AlterTenantPropertyAction.INSTANCE, TransportAlterTenantPropertyAction.class);
        registerAction(ShowTenantsAction.INSTANCE, TransportShowTenantsAction.class);
        ...
        registerAction(AddUserOrResetPasswdAction.INSTANCE, TransportAddUserOrResetPasswdAction.class);
        registerAction(GrantOrRevokeUserPrivilegeAction.INSTANCE, TransportGrantOrRevokeUserPrivilegeAction.class);
        registerAction(ShowUserPropertyAction.INSTANCE, TransportShowUserPropertyAction.class);
        registerAction(ResetWhitelistAction.INSTANCE, TransportResetWhitelistAction.class);
        registerAction(DropUserAction.INSTANCE, TransportDropUserAction.class);
        ...
        registerAction(IndexShardStatsAction.INSTANCE, TransportIndexShardStatsAction.class);
