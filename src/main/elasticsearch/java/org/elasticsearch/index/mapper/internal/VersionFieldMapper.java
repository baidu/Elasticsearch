...
public class VersionFieldMapper extends MetadataFieldMapper {
    ...
    public static class Defaults {
        ...
        public static final String VERSION_TYPE = "external";
    ...
    public static class Builder extends MetadataFieldMapper.Builder<Builder, VersionFieldMapper> {
        ...
        private String versionType = Defaults.VERSION_TYPE;
        ...
        public VersionFieldMapper build(BuilderContext context) {
            return new VersionFieldMapper(context.indexSettings(), path, versionType);
        }
    }
    ...
    private VersionFieldMapper(Settings indexSettings, String path, String versionType) {
    ...
    protected void doMerge(Mapper mergeWith, boolean updateAllTypes) {
        VersionFieldMapper fieldMergeWith = (VersionFieldMapper) mergeWith;
        this.path = fieldMergeWith.path();
        if (fieldMergeWith.VersionType() != null) {
            this.versionType = fieldMergeWith.VersionType();
        }
    }
}
