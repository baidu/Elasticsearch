...
class DocumentParser implements Closeable {
    ...
    public ParsedDocument parseDocument(SourceToParse source) throws MapperParsingException {
        ...
        source.mappingVersion(docMapper.mappingVersion());
        ...
        ParsedDocument doc = new ParsedDocument(context.uid(), context.version(), context.id(), context.type(),
                source.routing(), source.timestamp(), source.ttl(), docMapper.mappingVersion(), context.docs(),
