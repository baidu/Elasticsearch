...
public abstract class NumberFieldMapper extends FieldMapper implements AllFieldMapper.IncludeInAll {
    ...
    public static abstract class NumberFieldType extends MappedFieldType {
        ...
        @Override
        public boolean checkCompatibility(MappedFieldType other,
                List<String> conflicts, boolean strict, boolean reindex) {
            boolean needReindex = super.checkCompatibility(other, conflicts, strict, reindex);
