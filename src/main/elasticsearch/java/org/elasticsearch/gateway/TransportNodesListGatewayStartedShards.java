...
import io.crate.sql.parser.StatementBuilder.integer_return;
...
public class TransportNodesListGatewayStartedShards extends TransportNodesAction<TransportNodesListGatewayStartedShards.Request, TransportNodesListGatewayStartedShards.NodesGatewayStartedShards, TransportNodesListGatewayStartedShards.NodeRequest, TransportNodesListGatewayStartedShards.NodeGatewayStartedShards>
            ...
            if (shardStateMetaData != null) {
                ...
                if (metaData != null) {
                    ...
                    try {
                        ...
                        numDocs = Store.tryOpenIndex(shardPath.resolveIndex());
                        ...
                        return new NodeGatewayStartedShards(clusterService.localNode(), shardStateMetaData.version, exception, numDocs);
                    }
                }
                ...
                if (indexUUID.equals(shardStateMetaData.indexUUID) == false
                    ...
                    return new NodeGatewayStartedShards(clusterService.localNode(), shardStateMetaData.version, numDocs);
                }
            }
            logger.trace("{} no local shard info found", shardId);
            return new NodeGatewayStartedShards(clusterService.localNode(), -1, numDocs);
        } catch (Exception e) {
    ...
    public static class NodeGatewayStartedShards extends BaseNodeResponse {
        ...
        public NodeGatewayStartedShards(DiscoveryNode node, long version, int numDocs) {
            this(node, version, null, numDocs);
        }

        public NodeGatewayStartedShards(DiscoveryNode node, long version, Throwable storeException, int numDocs) {
            super(node);
