...
public class ThreadPool extends AbstractComponent {
    ...
    static {
        ...
        map.put(Names.REINDEX, ThreadPoolType.SCALING);
    ...
    public ThreadPool(Settings settings) {
        ...
        add(defaultExecutorTypeSettings, new ExecutorSettingsBuilder(Names.REINDEX).size(halfProcMaxAt10).keepAlive("5m"));
