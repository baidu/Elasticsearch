...
public class RestShardsAction extends AbstractCatAction {
    ...
    protected Table getTableWithHeader(final RestRequest request) {
        ...
        table.startHeaders()
                ...
                .addCell("prirep", "default:true;alias:p,pr,primaryOrReplica;desc:primary or replica")
                .addCell("state", "default:true;alias:st;desc:shard state")
                .addCell("docs", "default:true;alias:d,dc;text-align:right;desc:number of docs in shard")
                .addCell("store", "default:true;alias:sto;text-align:right;desc:store size of shard (how much disk it uses)")
                .addCell("reindex_rate", "default:true;alias:r,rate;text-align:right;desc:rate of reindex on shard")
                .addCell("txid", "default:false;alias:d,dc;text-align:right;desc:latest txid that the shard catches up to")
                .addCell("dlsn", "default:false;alias:sto;text-align:right;desc:latest dlsn that the shard catches up to")
    ...
    private Table buildTable(RestRequest request, ClusterStateResponse state, IndicesStatsResponse stats) {
        ...
        for (ShardRouting shard : state.getState().routingTable().allShards()) {
            ...
            table.addCell(commonStats == null ? null : commonStats.getReindexStats().getRate());
            table.addCell(commonStats == null ? null : commonStats.getDLStats().getLatestTxid());
            table.addCell(commonStats == null ? null : commonStats.getDLStats().getLatestDlsn());
