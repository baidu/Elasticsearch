...
public class RestClusterUpdateSettingsAction extends BaseRestHandler {
    ...
    public RestClusterUpdateSettingsAction(Settings settings, RestController controller, Client client) {
        ...
        controller.registerHandler(RestRequest.Method.PUT, "/_cluster/settings/{tenant_name}", this);
    }

    @Override
    public void handleRequest(final RestRequest request, final RestChannel channel, final Client client) throws Exception {
        final ClusterUpdateSettingsRequest clusterUpdateSettingsRequest = Requests.clusterUpdateSettingsRequest();
        clusterUpdateSettingsRequest.tenantName(request.param("tenant_name", null));
