...
import org.elasticsearch.rest.action.admin.cluster.node.add.RestAddNodesAction;
import org.elasticsearch.rest.action.admin.cluster.node.delete.RestDeleteNodesAction;
...
public class RestActionModule extends AbstractModule {
    ...
    protected void configure() {
        ...
        bind(RestDeleteNodesAction.class).asEagerSingleton();
        bind(RestAddNodesAction.class).asEagerSingleton();
/*        bind(RestCreateTenantAction.class).asEagerSingleton();
        bind(RestDeleteTenantAction.class).asEagerSingleton();
        bind(RestMigrateIndexTenantAction.class).asEagerSingleton();
        bind(RestAddTenantNodesAction.class).asEagerSingleton();
        bind(RestDeleteTenantNodesAction.class).asEagerSingleton();*/
