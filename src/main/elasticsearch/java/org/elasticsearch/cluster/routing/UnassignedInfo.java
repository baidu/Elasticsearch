...
public class UnassignedInfo implements ToXContent, Writeable<UnassignedInfo> {
    ...
    private static final TimeValue DEFAULT_DELAYED_NODE_LEFT_TIMEOUT = TimeValue.timeValueMinutes(15);
    ...
    public enum Reason {
        ...
        REPLICA_ADDED,
        /**
         * primary report a failure of the shard while writing
         */
        PRIMARY_REPORT_FAILURE,
        /**
    ...
    public int hashCode() {
        ...
        result = 31 * result + (int) (unassignedTimeMillis ^ (unassignedTimeMillis >>> 32));
