...
public class IndexMetaData implements Diffable<IndexMetaData>, FromXContentBuilder<IndexMetaData>, ToXContent  {
    ...
    public static final String SETTING_USING_DL_ENGINE = "index.engine.use_distributed_log";
    public static final boolean SETTING_USING_DL_ENGINE_DEFAULT = false;
    public static final String SETTING_DL_SNAPSHOT_RECOVERY_ROWS = "index.engine.dl.snapshot_recovery_rows";
    public static final String SETTING_DL_TRANSLOG_RECOVERY_GAP_ROWS = "index.engine.dl.translog_recovery_gap_rows";
    ...
    private final long indexOwnerTenantId;

    private IndexMetaData(String index, long version, State state, Settings settings, ImmutableOpenMap<String, MappingMetaData> mappings, ImmutableOpenMap<String, AliasMetaData> aliases, ImmutableOpenMap<String, Custom> customs, long indexOwnerTenantId) {
        ...
        this.indexOwnerTenantId = indexOwnerTenantId;
    }
    ...
    public long getIndexOwnerTenantId() {
        return this.indexOwnerTenantId;
    }
    
    public long indexOwnerTenantId() {
        return this.indexOwnerTenantId;
    }
    ...
    public boolean equals(Object o) {
        ...
        if (indexOwnerTenantId != that.indexOwnerTenantId) {
            return false;
        }
    ...
    public Diff<IndexMetaData> diff(IndexMetaData previousState) {
        if (previousState == null) {
            previousState = IndexMetaData.PROTO;
        }
    ...
    private static class IndexMetaDataDiff implements Diff<IndexMetaData> {
        ...
        public IndexMetaDataDiff(IndexMetaData before, IndexMetaData after) {
            ...
            tenantId = after.indexOwnerTenantId;
        }
    ...
    public IndexMetaData readFrom(StreamInput in) throws IOException {
        ...
        builder.indexOwnerTenantId(in.readLong());
    ...
    public void writeTo(StreamOutput out) throws IOException {
        ...
        out.writeLong(version);
        out.writeByte(state.id());
        out.writeLong(indexOwnerTenantId);
    ...
    public static class Builder {
        ...
        private long indexOwnerTenantId = TenantProperty.ROOT_TENANT_ID;
        ...
        public Builder(String index) {
            ...
            this.indexOwnerTenantId = TenantProperty.ROOT_TENANT_ID;
        }
        ...
        public Builder(IndexMetaData indexMetaData) {
            ...
            this.indexOwnerTenantId = indexMetaData.indexOwnerTenantId;
        }
        ...
        public Builder putMapping(String type, String source, long mappingVersion) throws IOException {
            try (XContentParser parser = XContentFactory.xContent(source).createParser(source)) {
                putMapping(new MappingMetaData(type, parser.mapOrdered(), mappingVersion));
            }
            return this;
        }
        ...
        public Builder indexOwnerTenantId(long newTenantId) {
            this.indexOwnerTenantId = newTenantId;
            return this;
        }
        ...
        public static void toXContent(IndexMetaData indexMetaData, XContentBuilder builder, ToXContent.Params params) throws IOException {
            ...
            builder.field("tenant_id", indexMetaData.indexOwnerTenantId);
            ...
            for (ObjectObjectCursor<String, MappingMetaData> cursor : indexMetaData.getMappings()) {
                if (binary) {
                    ...
                    mapping.put(MappingMetaData.MAPPING_VERSION, cursor.value.mappingVersion());
                    parser.close();
                    XContentBuilder mappingBuilder = XContentFactory.jsonBuilder().map(mapping);
                    CompressedXContent source = new CompressedXContent(mappingBuilder.bytes());
        ...
        public static IndexMetaData fromXContent(XContentParser parser) throws IOException {
            ...
            while ((token = parser.nextToken()) != XContentParser.Token.END_OBJECT) {
                if (token == XContentParser.Token.FIELD_NAME) {
                    ...
                    if ("settings".equals(currentFieldName)) {
                        ...
                        while ((token = parser.nextToken()) != XContentParser.Token.END_OBJECT) {
                            if (token == XContentParser.Token.FIELD_NAME) {
                                ...
                                // TODO GaoPan: when run to here? how to get version?
                                builder.putMapping(new MappingMetaData(mappingType, mappingSource, 1));
                            }
                        }
                    ...
                    if ("mappings".equals(currentFieldName)) {
                        while ((token = parser.nextToken()) != XContentParser.Token.END_ARRAY) {
                            if (token == XContentParser.Token.VALUE_EMBEDDED_OBJECT) {
                                ...
                                Map<String, Object> mapping = parser.mapOrdered();
                                if (mapping.containsKey(MappingMetaData.MAPPING_VERSION)) {
                                    mappingVersion = (int)mapping.get(MappingMetaData.MAPPING_VERSION);
                                    mapping.remove(MappingMetaData.MAPPING_VERSION);
                                }
                                if (mapping.size() == 1) {
                                    String mappingType = mapping.keySet().iterator().next();
                                    builder.putMapping(new MappingMetaData(mappingType, mapping, mappingVersion));
                                }
                            }
                        }
                    }
                    ...
                    } else if ("tenant_id".equals(currentFieldName)) {
                        builder.indexOwnerTenantId(parser.longValue());
                    }
                }
            }
            return builder.build();
