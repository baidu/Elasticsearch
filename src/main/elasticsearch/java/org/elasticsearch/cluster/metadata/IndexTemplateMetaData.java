...
public class IndexTemplateMetaData extends AbstractDiffable<IndexTemplateMetaData> {
    ...
    private final long templateOwnerTenantId;
    ...
    public long getTemplateOwnerTenantId() {
        return this.templateOwnerTenantId;
    }
    ...
    public IndexTemplateMetaData readFrom(StreamInput in) throws IOException {
        ...
        builder.templateOwnerTenantId(in.readLong());
    ...
    public void writeTo(StreamOutput out) throws IOException {
        ...
        out.writeInt(order);
        out.writeLong(templateOwnerTenantId);
    ...
    public static class Builder {
        ...
        public Builder templateOwnerTenantId(long newTenantId) {
        ...
        public IndexTemplateMetaData build() {
            return new IndexTemplateMetaData(name, order, template, settings, mappings.build(), aliases.build(), customs.build(), tenantId);
        }
        ...
        public static void toXContent(IndexTemplateMetaData indexTemplateMetaData, XContentBuilder builder, ToXContent.Params params) throws IOException {
            ...
            builder.field("tenant_id", indexTemplateMetaData.templateOwnerTenantId);
            ...
            while ((token = parser.nextToken()) != XContentParser.Token.END_OBJECT) {
                if (token == XContentParser.Token.FIELD_NAME) {
                    ...
                    if ("template".equals(currentFieldName)) {
                        ...
                        builder.templateOwnerTenantId(parser.longValue());
                    }
                }
            }
            return builder.build();
