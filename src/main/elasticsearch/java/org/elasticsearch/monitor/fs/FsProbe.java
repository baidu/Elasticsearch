...
public class FsProbe extends AbstractComponent {
    ...
    public static FsInfo.Path getFSInfo(NodePath nodePath) throws IOException {
        ...
        fsPath.total = nodePath.getTotalSpace();
        fsPath.free = nodePath.getUnallocatedSpace();
        fsPath.available = nodePath.getUsableSpace();
        fsPath.type = nodePath.type();
        fsPath.mount = nodePath.mount();
