...
public class AlterTableOperation {
    ...
    public ListenableFuture<Long> executeAlterTable(AlterTableAnalyzedStatement analysis) {
        ...
        if (table.isPartitioned()) {
            ...
            if (partitionName.isPresent()) {
                ...
                results.add(updateTemplate(analysis.tableParameter(), table.ident(), analysis));
    ...
    private ListenableFuture<Long> updateTemplate(TableParameter tableParameter, TableIdent tableIdent, AlterTableAnalyzedStatement statement) {
        return updateTemplate(tableParameter.mappings(), tableParameter.settings(), tableIdent, statement);
    }
