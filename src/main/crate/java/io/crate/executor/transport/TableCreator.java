...
public class TableCreator {
    ...
    private CreateIndexRequest createIndexRequest(CreateTableAnalyzedStatement statement) {
        CreateIndexRequest createIndexRequest = new CreateIndexRequest(statement.tableIdent().indexName(), settings(statement))
                .mapping(Constants.DEFAULT_MAPPING_TYPE, statement.mapping());
        createIndexRequest.putHeader(LoginUserContext.USER_INFO_KEY, statement.getParameterContext().getLoginUserContext());
