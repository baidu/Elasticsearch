...
public class CrateTableSettings {
    ...
    public static final BoolSetting USING_DL_ENGINE = new BoolSetting(TableParameterInfo.USING_DL_ENGINE, IndexMetaData.SETTING_USING_DL_ENGINE_DEFAULT, false);
    public static final IntSetting DL_SNAPSHOT_RECOVERY_ROWS = new IntSetting(TableParameterInfo.DL_SNAPSHOT_RECOVERY_ROWS, 100000, true);
}
