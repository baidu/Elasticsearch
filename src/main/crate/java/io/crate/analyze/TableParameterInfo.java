...
public class TableParameterInfo {
    ...
    public static final String USING_DL_ENGINE = IndexMetaData.SETTING_USING_DL_ENGINE;
    public static final String DL_SNAPSHOT_RECOVERY_ROWS = IndexMetaData.SETTING_DL_SNAPSHOT_RECOVERY_ROWS;
