...
public class AnalyzedStatementVisitor<C, R> {
    ...
    public R visitCreateUserAnalyzedStatement(CreateUserAnalyzedStatement analysis, C context) {
        return visitDDLAnalyzedStatement(analysis, context);
    }
    
    public R visitDropUserAnalyzedStatement(DropUserAnalyzedStatement analysis, C context) {
        return visitDDLAnalyzedStatement(analysis, context);
    }
    
    public R visitResetPasswordAnalyzedStatement(ResetPasswordAnalyzedStatement analysis, C context) {
        return visitDDLAnalyzedStatement(analysis, context);
    }
    
    public R visitResetWhitelistAnalyzedStatement(ResetWhitelistAnalyzedStatement analysis, C context) {
        return visitDDLAnalyzedStatement(analysis, context);
    }
    
    public R visitGrantPrivilegeAnalyzedStatement(GrantPrivilegeAnalyzedStatement analysis, C context) {
        return visitDDLAnalyzedStatement(analysis, context);
    }
    
    public R visitRevokePrivilegeAnalyzedStatement(RevokePrivilegeAnalyzedStatement analysis, C context) {
        return visitDDLAnalyzedStatement(analysis, context);
    }
    
    public R visitShowGrantsAnalyzedStatement(ShowGrantsAnalyzedStatement analysis, C context) {
        return visitShowAnalyzedStatement(analysis, context);
    }
    ...
    public R visitCreateTenantAnalyzedStatement(CreateTenantAnalyzedStatement analysis, C context) {
        return visitDDLAnalyzedStatement(analysis, context);
    }
    
    public R visitDropTenantAnalyzedStatement(DropTenantAnalyzedStatement analysis, C context) {
        return visitDDLAnalyzedStatement(analysis, context);
    }
    
    public R visitAlterTenantPropertyAnalyzedStatement(AlterTenantPropertyAnalyzedStatement analysis, C context) {
        return visitDDLAnalyzedStatement(analysis, context);
    }
    
    public R visitAlterTenantModifyNodesAnalyzedStatement(AlterTenantModifyNodesAnalyzedStatement analysis, C context) {
        return visitDDLAnalyzedStatement(analysis, context);
    }
    
    public R visitMigrateTableAnalyzedStatement(MigrateTableAnalyzedStatement analysis, C context) {
        return visitDDLAnalyzedStatement(analysis, context);
    }
    
    public R visitShowTenantsAnalyzedStatement(ShowTenantsAnalyzedStatement analysis, C context) {
        return visitShowAnalyzedStatement(analysis, context);
    }
}
