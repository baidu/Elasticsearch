...
public class TablePropertiesAnalyzer {
    ...
    private static final ImmutableBiMap<String, String> CRATE_TO_ES_SETTINGS_MAP =
            ImmutableBiMap.<String, String>builder()
                    ...
                    .put(stripIndexPrefix(TableParameterInfo.USING_DL_ENGINE), TableParameterInfo.USING_DL_ENGINE)
                    .put(stripIndexPrefix(TableParameterInfo.DL_SNAPSHOT_RECOVERY_ROWS), TableParameterInfo.DL_SNAPSHOT_RECOVERY_ROWS)
    ...
    private static final ImmutableMap<String, SettingsApplier> SETTINGS_APPLIER =
            ImmutableMap.<String, SettingsApplier>builder()
                    ...
                    .put(TableParameterInfo.USING_DL_ENGINE, new SettingsAppliers.BooleanSettingsApplier(CrateTableSettings.USING_DL_ENGINE))
                    .put(TableParameterInfo.DL_SNAPSHOT_RECOVERY_ROWS, new SettingsAppliers.IntSettingsApplier(CrateTableSettings.DL_SNAPSHOT_RECOVERY_ROWS))
