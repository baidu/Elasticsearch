...
public class ShardProjectorChain {
    ...
    private RowDownstream getRowDownstream(int maxNumShards) {
        if (maxNumShards == 1) {
            LOGGER.trace("Getting RowDownstream for 1 upstream, repeat support: " + firstNodeProjector.requirements());
            ...
            LOGGER.trace("Getting RowDownstream for multiple upstreams; unsorted; repeat support: "
