...
public abstract class AstVisitor<R, C>
{
    ...
    public R visitResetPassword(ResetPassword node, C context) {
        return visitStatement(node, context);
    }
    
    public R visitResetWhitelist(ResetWhitelist node, C context) {
        return visitStatement(node, context);
    }
    ...
    public R visitCreateTenant(CreateTenant node, C context) {
        return visitStatement(node, context);
    }
    
    public R visitDropTenant(DropTenant node, C context) {
        return visitStatement(node, context);
    }
    
    public R visitShowTenants(ShowTenants node, C context) {
        return visitStatement(node, context);
    }
    
    public R visitAlterTenantProperty(AlterTenantProperty node, C context) {
        return visitStatement(node, context);
    }
    
    public R visitAlterTenantModifyNodes(AlterTenantModifyNodes node, C context) {
        return visitStatement(node, context);
    }
    
    public R visitMigrateTable(MigrateTable node, C context) {
        return visitStatement(node, context);
    }
}
