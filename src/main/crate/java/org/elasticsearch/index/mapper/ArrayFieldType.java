...
class ArrayFieldType extends MappedFieldType {
    ...
    public boolean checkCompatibility(MappedFieldType other, List<String> conflicts, boolean strict, boolean reindex) {
        ...
        needReindex |= super.checkCompatibility(other, conflicts, strict, reindex);
        // it's an array field type, lets check the inner type
        needReindex |= innerFieldType.checkCompatibility(((ArrayFieldType) other).innerFieldType, conflicts, strict, reindex);
        return needReindex;
    }
