...
public class AlterTenantProperty extends Statement {

    private final String tenantName;
    private final Optional<GenericProperties> properties;

    public AlterTenantProperty(String name,
    ...
    {
        return visitor.visitAlterTenantProperty(this, context);
    }
    ...
    public boolean equals(Object obj) {
        ...
        if (getClass() != obj.getClass())
            return false;
        AlterTenantProperty other = (AlterTenantProperty) obj;
        if (properties == null) {
