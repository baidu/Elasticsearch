...
import io.crate.sql.tree.DropTenant;
...
public class DropTenantStatementAnalyzer  extends DefaultTraversalVisitor<DropTenantAnalyzedStatement, Analysis> {

    @Inject
    public DropTenantStatementAnalyzer() {
    }

    @Override
    public DropTenantAnalyzedStatement visitDropTenant(DropTenant node, Analysis context) {
        ...
        DropTenantAnalyzedStatement statement = new DropTenantAnalyzedStatement(node.getTenantName());
        return statement;
    }
